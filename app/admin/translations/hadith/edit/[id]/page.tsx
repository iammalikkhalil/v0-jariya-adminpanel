...
export default function EditHadithTranslationPage() {
      ...
      <AuthGuard>
        <AdminLayout>
          <div className="space-y-6">
            <div>
              <h1 className="text-3xl font-islamic text-primary mb-2">Edit Hadith Translation</h1>
    ...
    <AuthGuard>
      <AdminLayout>
        <div className="space-y-6">
          ...
          <HadithTranslationForm translation={translation} mode="edit" />
        </div>
      </AdminLayout>
    </AuthGuard>
  )
