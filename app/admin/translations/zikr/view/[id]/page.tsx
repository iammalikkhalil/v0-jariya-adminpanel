...
import { ZikrTranslationView } from "@/components/zikr-translation-view"
...
import { deleteZikrTranslation } from "@/lib/api/translation"

export default function ZikrTranslationViewPage() {
  ...
  const handleDelete = async () => {
    ...
    setIsDeleting(true)
    try {
      const response = await deleteZikrTranslation(translation.id)
      if (response.success) {
        ...
        <AdminLayout>
          <div className="space-y-6">
            ...
            <div className="text-center py-12">
              ...
              <Button onClick={() => router.push("/admin/translations/zikr")}>
        ...
        <div className="space-y-6">
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-2">
              <Link href={`/admin/translations/zikr/edit/${translation.id}`}>
